...
const scrapeVice = require("./scrapers/vice");

const username = "vicecom"; // your Vice profile on ChumCity
...
(async () => {
  ...
  try {
    ...
    // 🔎 SCRAPE LATEST FROM VICE
    const { title, link } = await scrapeVice();
    const postText = `📰 Vice: ${title}\n${link}`;
