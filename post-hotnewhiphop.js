...
const scrapeHotNewHipHop = require("./scrapers/hotnewhiphop");

const username = "hotnewhiphop"; // update if needed
...
(async () => {
  ...
  try {
    ...
    // 🔎 SCRAPE
    const { title, link } = await scrapeHotNewHipHop();
    const postText = `🔥 HNHH: ${title}\n${link}`;
